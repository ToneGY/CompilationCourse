...
bb2:                                              ; preds = %bb3, %bb1
  ...
  %r165 = add i32 %r160, 0
  %r166 = add i32 %r164, 0
  %r107 = getelementptr i32, ptr %r100, i32 %r166
  %r167 = load i32, ptr %r107, align 4
  %r109 = icmp sgt i32 %r165, %r167
  br i1 %r109, label %bb5, label %bb4

bb5:                                              ; preds = %bb2
  %r168 = add i32 %r164, 0
  %r169 = load i32, ptr @N, align 4
...
bb7:                                              ; preds = %bb6
  ...
  %r180 = add i32 %r179, 0
  %r181 = add i32 %r175, 0
  %r123 = getelementptr i32, ptr %r100, i32 %r181
  %r182 = add i32 %r180, 0
  %r125 = getelementptr i32, ptr %r100, i32 %r182
  %r183 = load i32, ptr %r125, align 4
  store i32 %r183, ptr %r123, align 4
  %r184 = add i32 %r164, 0
  %r128 = getelementptr i32, ptr %r100, i32 %r184
  %r185 = add i32 %r160, 0
  store i32 %r185, ptr %r128, align 4
  %r186 = add i32 %r175, 0
  %r187 = sub i32 %r186, 1
  %r188 = add i32 %r187, 0
  br label %bb6
...
bb9:
  ...
  %r193 = add i32 %r192, 0
  %r194 = add i32 %r193, 0
  %r195 = call i32 @insert(ptr %r132, i32 %r194)
  %r196 = add i32 %r195, 0
  br label %bb10
...
bb10:                                             ; preds = %bb11, %bb9
  ...
  %r198 = add i32 %r197, 0
  %r199 = load i32, ptr @N, align 4
  %r150 = icmp slt i32 %r198, %r199
  br i1 %r150, label %bb11, label %bb12

bb11:                                             ; preds = %bb10
  %r200 = add i32 %r197, 0
  %r152 = getelementptr [11 x i32], ptr %r132, i32 0, i32 %r200
  %r201 = load i32, ptr %r152, align 4
  %r202 = add i32 %r201, 0
  %r203 = add i32 %r202, 0
