...
bb1:
  ...
  %r102 = icmp slt i32 1, 9
  br i1 %r102, label %bb5, label %bb4
...
bb3:                                              ; preds = %bb5
  store i32 1, ptr %r105, align 4
  br label %bb2

bb4:                                              ; preds = %bb5, %bb1
  store i32 0, ptr %r105, align 4
  br label %bb2

bb2:                                              ; preds = %bb4, %bb3
  %r106 = load i32, ptr %r105, align 4
  store i32 %r106, ptr %r101, align 4
  br label %bb6
...
bb8:                                              ; preds = %bb6
  %r112 = load i32, ptr %r101, align 4
...
1:                                                ; No predecessors!
  store i32 2, ptr %r115, align 4
  %r116 = load i32, ptr %r115, align 4
  ret i32 %r116

2:                                                ; No predecessors!
  store i32 3, ptr %r117, align 4
