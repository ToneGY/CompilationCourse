...
bb3:                                              ; preds = %bb2
  %r189 = add i32 %r186, 0
  %r107 = getelementptr [32768 x i32], ptr @program, i32 0, i32 %r189
  %r190 = call i32 @getch()
  store i32 %r190, ptr %r107, align 4
  %r191 = add i32 %r186, 0
  %r192 = add i32 %r191, 1
  %r193 = add i32 %r192, 0
  br label %bb2
...
bb4:                                              ; preds = %bb2
  %r194 = add i32 %r186, 0
  %r112 = getelementptr [32768 x i32], ptr @program, i32 0, i32 %r194
...
bb6:                                              ; preds = %bb29, %bb5
  %r199 = add i32 %r198, 0
  %r118 = getelementptr i32, ptr %r113, i32 %r199
  %r200 = load i32, ptr %r118, align 4
  %r120 = icmp ne i32 %r200, 0
  br i1 %r120, label %bb7, label %bb8

bb7:                                              ; preds = %bb6
  %r201 = add i32 %r198, 0
  %r122 = getelementptr i32, ptr %r113, i32 %r201
  %r202 = load i32, ptr %r122, align 4
  %r203 = add i32 %r202, 0
  %r204 = add i32 %r203, 0
...
bb9:                                              ; preds = %bb7
  %r246 = load i32, ptr @ptr, align 4
  %r247 = add i32 %r246, 1
  store i32 %r247, ptr @ptr, align 4
  br label %bb11
...
bb12:                                             ; preds = %bb11
  %r244 = load i32, ptr @ptr, align 4
  %r245 = sub i32 %r244, 1
  store i32 %r245, ptr @ptr, align 4
  br label %bb14
...
bb15:                                             ; preds = %bb14
  ...
  %r208 = load i32, ptr @ptr, align 4
  %r137 = getelementptr [65536 x i32], ptr @tape, i32 0, i32 %r208
  %r209 = load i32, ptr %r137, align 4
  %r210 = add i32 %r209, 1
  store i32 %r210, ptr %r135, align 4
  br label %bb17
...
bb18:                                             ; preds = %bb17
  %r240 = load i32, ptr @ptr, align 4
  %r143 = getelementptr [65536 x i32], ptr @tape, i32 0, i32 %r240
  %r241 = load i32, ptr @ptr, align 4
  %r145 = getelementptr [65536 x i32], ptr @tape, i32 0, i32 %r241
  %r242 = load i32, ptr %r145, align 4
  %r243 = sub i32 %r242, 1
  store i32 %r243, ptr %r143, align 4
  br label %bb20
...
bb21:                                             ; preds = %bb20
  %r238 = load i32, ptr @ptr, align 4
  %r151 = getelementptr [65536 x i32], ptr @tape, i32 0, i32 %r238
  %r239 = load i32, ptr %r151, align 4
...
bb24:                                             ; preds = %bb23
  %r236 = load i32, ptr @ptr, align 4
  %r156 = getelementptr [65536 x i32], ptr @tape, i32 0, i32 %r236
  %r237 = call i32 @getch()
  store i32 %r237, ptr %r156, align 4
  br label %bb26
...
bb30:                                             ; preds = %bb26
  %r218 = load i32, ptr @ptr, align 4
  %r161 = getelementptr [65536 x i32], ptr @tape, i32 0, i32 %r218
  %r219 = load i32, ptr %r161, align 4
...
bb32:                                             ; preds = %bb31
  ...
  %r224 = add i32 %r223, 0
  %r225 = add i32 %r224, 0
  %r169 = getelementptr i32, ptr %r113, i32 %r225
  %r226 = load i32, ptr %r169, align 4
  %r227 = add i32 %r226, 0
  %r228 = add i32 %r227, 0
