...
define void @foo(ptr %r100) {
bb1:
  %r101 = getelementptr %Node, ptr %r100, i32 0, i32 0
  %r102 = call i32 @getint()
  store i32 %r102, ptr %r101, align 4
  %r103 = getelementptr %Node, ptr %r100, i32 0, i32 1
  %r104 = call i32 @getint()
  store i32 %r104, ptr %r103, align 4
  ret void
}

define void @baz(ptr %r105) {
bb2:
  %r106 = getelementptr %Node, ptr %r105, i32 2
  %r107 = getelementptr %Node, ptr %r106, i32 0, i32 0
  %r108 = call i32 @getint()
  store i32 %r108, ptr %r107, align 4
  %r109 = getelementptr %Node, ptr %r105, i32 2
  %r110 = getelementptr %Node, ptr %r109, i32 0, i32 1
  %r111 = call i32 @getint()
  store i32 %r111, ptr %r110, align 4
  ret void
}
...
bb3:
  ...
  %r112 = alloca %Node, align 8
  %r113 = getelementptr %Node, ptr %r112, i32 0, i32 0
  store i32 1, ptr %r113, align 4
  %r114 = getelementptr %Node, ptr %r112, i32 0, i32 1
  store i32 2, ptr %r114, align 4
  call void @foo(ptr %r112)
  call void @foo(ptr @d)
  call void @baz(ptr @e)
  %r115 = getelementptr %Node, ptr %r112, i32 0, i32 0
  %r116 = load i32, ptr %r115, align 4
  %r117 = getelementptr %Node, ptr %r112, i32 0, i32 1
  %r118 = load i32, ptr %r117, align 4
  %r119 = add i32 %r116, %r118
  call void @putint(i32 %r119)
  %r120 = getelementptr %Node, ptr @d, i32 0, i32 0
  %r121 = load i32, ptr %r120, align 4
  %r122 = getelementptr %Node, ptr @d, i32 0, i32 1
  %r123 = load i32, ptr %r122, align 4
  %r124 = add i32 %r121, %r123
  call void @putint(i32 %r124)
  %r125 = getelementptr [10 x %Node], ptr @e, i32 0, i32 2
  %r126 = getelementptr %Node, ptr %r125, i32 0, i32 0
  %r127 = load i32, ptr %r126, align 4
  %r128 = getelementptr [10 x %Node], ptr @e, i32 0, i32 2
  %r129 = getelementptr %Node, ptr %r128, i32 0, i32 1
